const activities = [
  {
    ...
    period: "2021 - 2023",
    description:
      "Managed a team of 6 members, created business strategies, and performed KPI analysis and reporting that boosted client acquisition by 50% over a year. Conducted market research, negotiations, budgeting, and KPI creation as Business Manager (2021-2022) securing contracts worth 5000€.",
  ...
  },
  {
    ...
    period: "2020 - 2021",
    description:
      "Performed macroeconomic and technical analysis, portfolio management and newsletter writing.",
  ...
  },
  {
    ...
    period: "2017 - 2019",
    description:
      "Trained in first aid, fire and military drills, and volunteer duties in events in the city (organization of marathon, local food bank).",
        ...
        <div className="space-y-6">
          {activities.map((activity, index) => (
            ...
            >
              ...
              {/* Uncomment if you want to show skills
